      ...
      <main>
        <header class="bg-dark mb-4">
          ...
          <div class="container-fluid">
            ...
            <a rel="noopener" href="https://github.com/henrik-ch" class="text-light" title="See repository on Github">Github</a>
          </div>
          </nav>
        </header>
        ...
        <footer class="bg-dark text-light p-4">
          <div class="container text-center">
            Made with <span class="pe-1">❤️</span> by <a class="text-light" href="https://beinghenrik.blogspot.com/" title="Henrik Karlsson Blog">Henrik Karlsson</a>
          </div>
        </footer>
      </main>
    </body>
