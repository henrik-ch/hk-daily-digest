...
module.exports.document = function (input_section, navbar_section) {
  ...
  module.exports.techdocument = function (input_section) {
    return `<!doctype html>
    <html lang="en">
  ...
  module.exports.newsdocument = function (input_section) {
    return `<!doctype html>
    <html lang="en">
  ...
  module.exports.financedocument = function (input_section) {
    return `<!doctype html>
    <html lang="en">
